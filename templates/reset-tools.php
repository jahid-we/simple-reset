        ...
        <div class="sr-card" data-type="posts">
            ...
            <div class="sr-card__footer">
                <form method="post">
                    <?php wp_nonce_field(
                        "sr_delete_posts",
                        "sr_delete_posts_nonce"
                    ); ?>
                    <button type="submit" name="sr_delete_posts" value="1" class="sr-btn sr-btn--danger sr-delete-trigger"<?php echo 0 ===
                    $counts["posts"]
        ...
        <div class="sr-card" data-type="pages">
            ...
            <div class="sr-card__footer">
                <form method="post">
                    <?php wp_nonce_field(
                        "sr_delete_pages",
                        "sr_delete_pages_nonce"
                    ); ?>
                    <button type="submit" name="sr_delete_pages" value="1" class="sr-btn sr-btn--danger sr-delete-trigger"<?php echo 0 ===
                    $counts["pages"]
                        ? ' disabled title="Nothing to delete"'
                        : ""; ?>>
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/></svg>
                        <?php echo 0 === $counts["pages"]
                            ? "Nothing to Delete"
                            : "Delete All Pages"; ?>
                    </button>
                </form>
        ...
        <div class="sr-card" data-type="media">
            ...
            <div class="sr-card__footer">
                <form method="post">
                    <?php wp_nonce_field(
                        "sr_delete_media",
                        "sr_delete_media_nonce"
                    ); ?>
                    <button type="submit" name="sr_delete_media" value="1" class="sr-btn sr-btn--danger sr-delete-trigger"<?php echo 0 ===
                    $counts["media"]
                        ? ' disabled title="Nothing to delete"'
                        : ""; ?>>
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/></svg>
                        <?php echo 0 === $counts["media"]
                            ? "Nothing to Delete"
                            : "Delete All Media"; ?>
                    </button>
                </form>
        ...
        <div class="sr-card" data-type="comments">
            ...
            <div class="sr-card__footer">
                <form method="post">
                    ...
                    <button type="submit" name="sr_delete_comments" value="1" class="sr-btn sr-btn--danger sr-delete-trigger"<?php echo 0 ===
                    $counts["comments"]
                        ? ' disabled title="Nothing to delete"'
                        : ""; ?>>
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/></svg>
                        <?php echo 0 === $counts["comments"]
                            ? "Nothing to Delete"
                            : "Delete All Comments"; ?>
                    </button>
                </form>
            ...
            <div class="sr-card__footer">
                <form method="post">
                    <?php wp_nonce_field(
                        ...
                        "sr_delete_categories_nonce"
                    ); ?>
                    <button type="submit" name="sr_delete_categories" value="1" class="sr-btn sr-btn--danger sr-delete-trigger"<?php echo 0 ===
                    $counts["categories"]
                        ? ' disabled title="Nothing to delete"'
                        : ""; ?>>
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/></svg>
                        <?php echo 0 === $counts["categories"]
                            ? "Nothing to Delete"
        ...
        <div class="sr-card" data-type="tags">
            ...
            <div class="sr-card__footer">
                <form method="post">
                    <?php wp_nonce_field(
                        "sr_delete_tags",
                        "sr_delete_tags_nonce"
                    ); ?>
                    <button type="submit" name="sr_delete_tags" value="1" class="sr-btn sr-btn--danger sr-delete-trigger"<?php echo 0 ===
                    $counts["tags"]
                        ? ' disabled title="Nothing to delete"'
                        : ""; ?>>
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/></svg>
                        <?php echo 0 === $counts["tags"]
                            ? "Nothing to Delete"
                            : "Delete All Tags"; ?>
                    </button>
                </form>
    ...
    <circle cx="12" cy="7" r="4"/></svg></div>
            ...
            <div class="sr-card__footer">
                <form method="post">
                    ...
                    <button type="submit" name="sr_delete_users" value="1" class="sr-btn sr-btn--danger sr-delete-trigger"<?php echo 0 ===
                    $counts["users"]
                        ? ' disabled title="Nothing to delete"'
                        : ""; ?>>
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/></svg>
