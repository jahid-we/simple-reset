...
<div id="sr-modal" class="sr-modal" role="dialog" aria-modal="true" aria-labelledby="sr-modal-title">
    <div class="sr-modal-box">
        ...
        <h2 id="sr-modal-title" class="sr-modal-title"><?php esc_html_e( 'Confirm Permanent Deletion', 'simple-reset' ); ?></h2>
        <p class="sr-modal-desc"><?php esc_html_e( 'This action is irreversible. The selected content will be permanently erased from your database.', 'simple-reset' ); ?></p>
        <div class="sr-modal-input-wrap">
            <label for="sr-confirm-input" class="sr-modal-label"><?php esc_html_e( 'Type DELETE to confirm', 'simple-reset' ); ?></label>
        ...
        <?php if ( '1' === $require_backup ) : ?>
            <label class="sr-modal-backup-confirmation">
                ...
                <span><?php esc_html_e( 'I confirm that I have backed up the database.', 'simple-reset' ); ?></span>
            </label>
        <?php endif; ?>
        <div class="sr-modal-buttons">
            <button type="button" id="sr-modal-cancel" class="sr-btn sr-btn--ghost"><?php esc_html_e( 'Cancel', 'simple-reset' ); ?></button>
            <button type="button" id="sr-modal-confirm" class="sr-btn sr-btn--danger" disabled>
                ...
                <?php esc_html_e( 'Delete Permanently', 'simple-reset' ); ?>
            </button>
        </div>
    </div>
</div>
